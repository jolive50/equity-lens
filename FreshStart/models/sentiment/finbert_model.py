...
class FinBERTModel(BaseSentimentModel):
    """FinBERT sentiment model with fine-tuning capability.

    Uses TensorFlow backend for compatibility with project stack.
    """
    ...
    def fine_tune(
        ...
        """Fine-tune FinBERT on custom dataset.

        Args:
            train_texts: Training texts
            train_labels: Training labels (0=positive, 1=negative, 2=neutral)
        ...
        weights_file = os.path.join(output_dir, "finbert_weights.h5")
