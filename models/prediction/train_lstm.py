"""LSTM model training script with best practices.

Trains LSTM model on preprocessed SP500 data with:
...
def build_lstm_model(
    ...
    """Build LSTM model with configurable hyperparameters.
    ...
    Args:
        ...
        units_layer3: Units in third LSTM layer
    ...
    model = keras.Sequential([
        ...
        layers.LSTM(units_layer2, return_sequences=True, name='lstm_2'),
        layers.BatchNormalization(),
        layers.Dropout(dropout_rate),

        # Third LSTM layer (final, no return sequences)
        layers.LSTM(units_layer3, name='lstm_3'),
        layers.BatchNormalization(),
        layers.Dropout(dropout_rate),
