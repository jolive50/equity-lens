...
class _RoBERTaDataset(Dataset):
    """Dataset wrapper for RoBERTa fine-tuning."""
...
class RoBERTaModel(BaseSentimentModel):
    """RoBERTa sentiment model implemented with PyTorch transformers."""
    ...
    def fine_tune(
        ...
        train_dataset = _RoBERTaDataset(self.tokenizer, train_texts, train_labels)
        train_loader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True)

        val_loader = None
        if val_texts and val_labels:
            val_dataset = _RoBERTaDataset(self.tokenizer, val_texts, val_labels)
